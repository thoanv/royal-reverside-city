                                                                ...
                                                                <div class="text-center">
                                                                    <div>
                                                                        <button type="button"
                                                                                ...
                                                                                id="save_value">
                                                                            <i class="mdi mdi-arrow-collapse-right btn-icon-prepend"></i>
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="cf nestable-lists">
                                                                    <div class="dd" id="nestable">
                                                                        ...
                                                                        <input type="hidden" value="{{$menu['stt']}}"
                                                                               name="stt" class="stt">
